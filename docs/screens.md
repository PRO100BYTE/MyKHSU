...
- модальное окно учебного события отображается поверх таббара через системный слой `Modal`;
- нижний отступ модального окна рассчитывается динамически с учетом safe area на iOS/Android;

...
- отметка посещаемости прямо в карточке пары;
- статистика посещаемости по предметам;
- поиск свободных аудиторий по дню/паре;
...
Экран с информацией для новых студентов.
...
- словарь аббревиатур;
- модальные/вложенные представления с корректным возвратом назад.

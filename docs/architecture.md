...
- `ScheduleScreen.js`: расписание, экспорт, заметки, дедлайны ДЗ, избранное, посещаемость, свободные аудитории.
...
- `AcademicCalendarScreen.js`: учебные события, FAB-кнопка добавления, редактирование и экспорт в календарь и ICS.

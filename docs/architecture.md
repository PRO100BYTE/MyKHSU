...
- `AcademicEventModal.js`: модальное окно создания и редактирования учебного события в системном `Modal`-слое поверх tab bar, с динамическим нижним safe-area inset.

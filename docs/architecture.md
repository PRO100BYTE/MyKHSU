...
Критичные экраны:
- `ScheduleScreen.js`: расписание (студент, преподаватель, аудитория), экспорт, заметки, избранное, посещаемость, свободные аудитории.
...
- `attendanceStorage.js`: хранение и агрегирование посещаемости.
